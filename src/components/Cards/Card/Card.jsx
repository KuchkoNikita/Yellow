...
const Card = ({ distance, time, date, speed }) => (
  <div className="card">
    <svg
    ...
    <div className="card__info">
      ...
      <div className="card__info-block">
        <span className="card__key">Speed:</span>
        <span className="card__value">{speed.toString()}</span>
      </div>
      <div className="card__info-block">
        <span className="card__key">Distance:</span>
        <span className="card__value">{distance} km</span>
      </div>
      <div className="card__info-block">
        <span className="card__key">Time:</span>
        <span className="card__value">{time} min</span>
      </div>
    </div>
  </div>
);
