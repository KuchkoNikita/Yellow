  ...
  return (
    <div className="card">
      ...
      <div className="card__info">
        <span className="card__date">20.12.2017</span>
        <div className="card__info-block">
          <span className="card__key">Speed:</span>
          <span className="card__value">15</span>
        </div>
        <div className="card__info-block">
          <span className="card__key">Distance:</span>
          <span className="card__value">10 km</span>
        </div>
        <div className="card__info-block">
          <span className="card__key">Time:</span>
          <span className="card__value">60 min</span>
        </div>
      </div>
    </div>
  );
